...
(select a.DBName, max(a.backup_finish_date) as date, 'D' as type from (SELECT  d.Name AS DBName ,
...
(select a.DBName, max(a.backup_finish_date) as date, 'I' as type from (SELECT  d.Name AS DBName ,
        b.Backup_finish_date ,
    b.type,
        bmf.Physical_Device_name
FROM    sys.databases d
...
(select a.DBName, max(a.backup_finish_date) as date, 'L' as type from (SELECT  d.Name AS DBName ,
        b.Backup_finish_date ,
    b.type,
        bmf.Physical_Device_name
FROM    sys.databases d
