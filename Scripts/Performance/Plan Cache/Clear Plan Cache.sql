...
-- Flush the plan cache for the entire instance and suppress the regular completion message-- "DBCC execution completed. If DBCC printed error messages, contact your system administrator." DBCC FREEPROCCACHE WITHNO_INFOMSGS;
...
--Источник <https://www.sqlskills.com/blogs/glenn/eight-different-ways-to-clear-the-sql-server-plan-cache/> 
